...
@section('page-title',"Delivery Preference Edit")
                        ...
                        <div class="inner">
                            <div class="content_header_wrap">
                                <div class="hgroup divider-after left">
                                    <h1 class="lh-10">Delivery Preference Edit</h1>
                                </div>
                            </div>

                            <form method="POST"
                                  action="{{ route('delivery_preference.update', $deliveryPreference->id) }}"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-12 col-md-6 no-min-h">
                                                ...
                                                <input type="text"
                                                       ...
                                                       placeholder="Enter Delivery Preference"
                                                       value="{{ old('title', $deliveryPreference->title) }}" id="title"
                                                       name="title">
                                ...
                                <div class="content_footer_wrap">
                                    ...
                                    <a href="{{route('delivery_preference.index')}}"><button type="button" class="btn btn-primary" style="background-color: #bad709!important;">Cancel</button></a>
                                </div>
                            </form>
                        </div>
                    </aside>
