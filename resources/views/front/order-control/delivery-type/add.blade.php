                        ...
                        <div class="inner">
                            <div class="content_header_wrap">
                                <div class="hgroup divider-after left">
                                    <h1 class="lh-10">Add Delivery Type</h1>
                                </div>
                            </div>

                            <form method="POST" action="{{ route('delivery_type.store') }}" id="account-form"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-12 col-md-6 no-min-h">
                                                ...
                                                <input type="text"
                                                       ...
                                                       placeholder="Enter Delivery Type" id="title" name="title" required>
                                                <div class="invalid-feedback">
                                                    @if ($errors->has('title'))
                                                        {{ $errors->first('title') }}
                                                    @else
                                                        Please provide delivery type
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="content_footer_wrap">
                                    ...
                                    <a href="{{route('delivery_type.index')}}">
