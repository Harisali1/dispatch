                                    ...
                                    <table class="table table-striped tbl-responsive mb_last_row_hightlight mb_last_row_center">
                                        ...
                                        @foreach($orderCategories as $zones)
                                            <tr>
                                                ...
                                                <td class="valing-middle">{{ $zones->category->deliveryType->pluck('title')->implode(', ') }}</td>
                                                <td class="valing-middle">{{ $zones->category->deliveryPreference->pluck('title')->implode(', ') }}</td>
                                                <td class="valing-middle">{{ $zones->category->orderCategoryZone->pluck('title')->implode(', ') }}</td>
