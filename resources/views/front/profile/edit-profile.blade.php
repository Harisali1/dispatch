                            ...
                            <div class="widget_sidebar d-lg-block">
                                <nav class="sidebar_nav">
                                    <ul class="no-list">
                                        ...
                                        <li><a href="{{route('users.change-password')}}">Password Reset</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="inner">
                            ...
                            <form method="POST" action="{{ route('edit-profile.update') }}" id="account-form"
                                    ...
                                    <div class="section-inner">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-12 col-md-6 no-min-h">
                                                ...
                                                <br>
                                                <img style="border: solid;" onClick="preview(this);"
                                ...
                                <div class="content_footer_wrap">
                                    <button type="submit" class="btn btn-primary submitButton">Update profile</button>
                                </div>
                            </form>
                        </div>
                    </aside>
