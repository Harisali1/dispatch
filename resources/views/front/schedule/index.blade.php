                                ...
                                <div class="section-inner">
                                            ...
                                            <table class="table table-striped tbl-responsive mb_last_row_hightlight mb_last_row_center">
                                                ...
                                                @foreach($zoneSchedule['data'] as $zone)
                                                        <tr>
                                                            ...
                                                            <td class="valing-middle">{{ optional($zone->joeySchedule)->joey_id ?? 'N/A' }}</td>
                                                            <td class="valing-middle"></td>
                                    ...
                                    @else
                                        <table class="table table-striped tbl-responsive mb_last_row_hightlight mb_last_row_center">
                                            <thead>
                                            <tr>
                                                <th width="8%" scope="col">Zone ID</th>
                                                <th width="8%" scope="col">Schedule ID</th>
                                                <th width="10%" scope="col">Joey ID</th>
                                                <th width="12%" scope="col">Joey</th>
                                                <th width="20%" scope="col" class="align-right">Scheduled Start Time
                                                </th>
                                                <th width="20%" scope="col" class="align-right">Scheduled End Time
                                                </th>
                                                <th width="20%" scope="col" class="align-right">Joey Start Time</th>
                                                <th width="20%" scope="col" class="align-right">Joey End Time</th>
                                                <th width="20%" scope="col" class="align-right">Shift Premium</th>
